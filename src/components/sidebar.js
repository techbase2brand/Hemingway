    ...
    <div className="sidebars">
      ...
      >
        ...
        <Link style={{ textDecoration: 'none' }}>
          <Typography variant="h6" sx={{ m: 7 }} className="browser-temp">Browse Templates</Typography>
        </Link>
        ...
        <div className='paragraph' style={{ background: '#C7FFDD' }}>
          <span
            className='number-size' style={{ backgroundColor: 'rgba(15, 154, 70, 1)' }}
          >
            {data.passiveVoice}
          </span>
        ...
        <div className='paragraph' style={{ background: '#EDDFFF' }}>
          <span
            className='number-size' style={{ backgroundColor: 'rgba(112, 0, 255, 1)' }}
          >
            {data.complex}
          </span>
        ...
        <div className='paragraph' style={{ background: '#FFEFD0' }}>
          <span
            className='number-size' style={{ backgroundColor: 'rgba(255, 168, 0, 1)' }}
          >
            {data.hardSentences}
          </span>
        ...
        <div className='paragraph' style={{ background: '#FFD9D9' }}>
          <span
            className='number-size' style={{ backgroundColor: 'rgba(249, 67, 67, 1)' }}
          >
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body pb-5">
              ...
              <Button variant="contained" className='button-center' data-toggle="modal" data-target="#rewrite">
                Confirm
              </Button>
            </div>
          </div>
